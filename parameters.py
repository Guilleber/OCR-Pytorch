datasets = {'synthtext+mjsynth': {'train': ['/srv/storage/synalp@talc-data2.nancy.grid5000.fr/gleberre/datasets/ocr/mjsynth/train.jsonl',
            ...
            'full_words': {
                'train': ['!1000000:/srv/storage/synalp@talc-data2.nancy.grid5000.fr/gleberre/datasets/ocr/docbank/train_small.jsonl',
                    '*10:/srv/storage/synalp@talc-data2.nancy.grid5000.fr/gleberre/datasets/ocr/synthetic_t/train.jsonl',
                    ...
                    '*2:/srv/storage/synalp@talc-data2.nancy.grid5000.fr/gleberre/datasets/ocr/synthetic_m/train.jsonl',
                    '*10:!100000:/srv/storage/synalp@talc-data2.nancy.grid5000.fr/gleberre/datasets/ocr/iam/train_words.jsonl'],
                'val': ['/srv/storage/synalp@talc-data2.nancy.grid5000.fr/gleberre/datasets/ocr/iam/val_words.jsonl',
                    '/srv/storage/synalp@talc-data2.nancy.grid5000.fr/gleberre/datasets/ocr/funsd/train_words.jsonl',
                    '/srv/storage/synalp@talc-data2.nancy.grid5000.fr/gleberre/datasets/ocr/docbank/train_tiny.jsonl',
