...
class TransformerDecoder(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None,
                ...
                return_attn: Optional[bool] = False) -> Tensor:
        ...
        if return_attn:
            return (output, torch.cat([attn.unsqueeze(0) for attn in attn_weights], dim=0))
        else:
            return output
...
class TransformerDecoderLayer(Module):
    ...
    def forward(self, tgt: Tensor, memory: Tensor, tgt_mask: Optional[Tensor] = None,
                memory_mask: Optional[Tensor] = None, tgt_key_padding_mask: Optional[Tensor] = None,
                memory_key_padding_mask: Optional[Tensor] = None, return_attn: Optional[bool] = False) -> Tensor:
        ...
        tgt = self.norm3(tgt)
        return (tgt, attn_weights) if return_attn else tgt
